  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: "text-sm font-display font-medium capitalize",
        ...
        day_selected:
          "bg-grad-button text-white hover:brightness-110 focus:bg-grad-button focus:text-white",
        day_today: "bg-brand-lila/30 text-foreground font-semibold",
